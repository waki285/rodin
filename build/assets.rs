...
pub fn minify_assets() -> Result<()> {
    ...
    for file in js_files {
        ...
        // write to temp outfile so we can compute hash
        let tmp_dst = out_dir.join(format!("{}.tmp", file));
        ...
        manifest.insert(format!("/assets/build/{}", file), format!("/assets/build/{}", hashed_name));
    }
